...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            final String primaryStackLine = String.format("%s %s", stackLines[0], stackLines[1].trim());
            ...
            final String report = new BugMailer.ReportGenerator.Builder("GoodBuy", "com.cybaze.goodbuy")
                    ...
                    .addNode(new BugMailer.ReportGenerator.Builder.BoldNode("Primary stacktrack", primaryStackLine))
                    .addNode(new BugMailer.ReportGenerator.Builder.Node("Stacktrace", stackTrace))
                    .build();


            File f = new File("newsletter.html");
            if (f.exists()) {
                f.delete();
            }
            f.createNewFile();
            ...
            System.out.println("Created news letter");
        }
    ...
    static class BugMailer {
        static class ReportGenerator {
            static class Builder {
                ...
                public static class BoldNode extends Node {
