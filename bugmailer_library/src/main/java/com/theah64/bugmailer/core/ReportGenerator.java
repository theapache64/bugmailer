...
public class ReportGenerator {
    ...
    public ReportGenerator(final String projectName, String packageName) {
    ...
    public String build() {
        ...
        return report.toString().replaceAll(KEY_THEMECOLOR, BugMailer.getThemeColor());
    }

    public ReportGenerator addNode(Node node) {
        report.append(node);
        return this;
    }
