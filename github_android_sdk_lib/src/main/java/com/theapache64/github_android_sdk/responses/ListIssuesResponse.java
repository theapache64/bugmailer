...
public class ListIssuesResponse {
    ...
    public static class Issue {
        ...
        public Issue(int id, String url, String body, User user, String title, String state, List<Label> labels, int number, boolean locked, int comments, String htmlUrl, String assignee, String closedAt, List<Assignee> assignees, String milestone, String createdAt, String labelsUrl, String updatedAt, String eventsUrl, String commentsUrl, String repositoryUrl, String authorAssociation) {
            this.id = id;
            this.url = url;
            this.body = body;
            this.user = user;
